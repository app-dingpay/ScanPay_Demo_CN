			...
			type:"post",      							// 数据提交方式
         	...
         	success:function(data,textStatus){			// 回调成功
         	 			...
         	 			if( resp_code == "SUCCESS" && result_code == "0" ){         	 		
         	 				...
         	 				var st = $("#service_type option:selected").val();
         	 				
         	 				if( st == "qq_scan" ){		//选择QQ扫码支付时，对返回的qrcode值先进行解码，再生成二维码
  ...
  <body>
	<table>
		<tr>
  				...
  				<form id="ScanPay">
					...
					<div>业务类型(service_type)：
						<select name="service_type" id="service_type">
							...
							<option value="jd_scan">jd_scan</option>
						</select> *	</div>												
					<div>服务器异步通知地址(notify_url)：<input Type="text" Name="notify_url" id="notify_url" value="http://zhangl.imwork.net:18286/ScanPay_Demo/Notify_Url.jsp"> * </div>				
  			...
  			<td><div id="showqrcode"><img src="./images/logo.png"></div></td>
		</tr>
		<tr>
			<td colspan="2">
				<div>返回的XML数据：</div>
